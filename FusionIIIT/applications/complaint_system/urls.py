...
urlpatterns = [
    ...
    url(
        r"^caretaker/worker_id_know_more/(?P<wid>[0-9]+)/complaint_reassign/(?P<cid>[0-9]+)/discharge_worker/$",
        views.discharge_worker,
        name="discharge_worker",
    ),
    url(
        r"^caretaker/worker_id_know_more/(?P<work_id>[0-9]+)/$",
        views.worker_id_know_more,
        name="come_back_to_this",
    ),
    url(
        r"^caretaker/worker_id_know_more/(?P<wid>[0-9]+)/complaint_reassign/(?P<iid>[0-9]+)/$",
        views.complaint_reassign,
    ),
    ...
    url(
        r"^caretaker/detail2/(?P<detailcomp_id1>[0-9]+)/$",
        views.detail2,
        name="detail2",
    ),
    ...
    url(
        r"^supervisor/caretaker_id_know_more/(?P<caretaker_id>[0-9]+)/$",
        views.caretaker_id_know_more,
    ),
    url(
        r"^supervisor/caretaker_id_know_more/(?P<caretaker_id>[0-9]+)/complaint_reassign_super/(?P<iid>[0-9]+)/$",
        views.complaint_reassign_super,
        name="complaint_reassign_super",
    ),
    url(
        r"^supervisor/detail3/(?P<detailcomp_id1>[0-9]+)/$",
        views.detail3,
        name="detail3",
    ),
    # CRUD task
    ...
    url(
        r"^caretaker/(?P<comp_id1>[0-9]+)/$", views.assign_worker, name="assign_worker"
    ),
    url(r"^caretaker/deletecomplaint/(?P<comp_id1>[0-9]+)/$", views.deletecomplaint),
    # url(r'^caretaker/(?P<comp_id>[0-9]+)/$', views.assign_worker),
    url(
        r"^caretaker/(?P<complaint_id>[0-9]+)/(?P<status>[0-9]+)/$", views.changestatus
    ),
