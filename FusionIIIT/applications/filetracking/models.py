...
class File(models.Model):
    ...
    designation = models.ForeignKey(
        ...
        null=True,
        related_name="upload_designation",
    )
...
class Tracking(models.Model):
    ...
    current_design = models.ForeignKey(
        HoldsDesignation, null=True, on_delete=models.CASCADE
    )
    ...
    receive_design = models.ForeignKey(
        Designation, null=True, on_delete=models.CASCADE, related_name="rec_design"
    )
