...
urlpatterns = [
    ...
    url(
        r"^brach-change-request/",
        views.branch_change_request,
    ...
    url(
        r"^acad_person/verifyCourse/drop/$",
        views.dropcourseadmin,
        name="dropcourseadmin",
    ),
    url(r"^branch-validate", views.approve_branch_change, name="branch_validate"),
    url(
        r"^acad_person/branch_change/$",
        views.acad_branch_change,
    ...
    url(
        r"^acad_person/gen_course_list$", views.gen_course_list, name="gen_course_list"
    ),
