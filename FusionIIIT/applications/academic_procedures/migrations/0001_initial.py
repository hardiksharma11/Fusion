            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="thesistopicprocess_co_supervisor",
                        to="globals.faculty",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="academic_information.curriculum",
                    ),
                ),
                (
                    "member1",
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="thesistopicprocess_member1",
                        to="globals.faculty",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="thesistopicprocess_member2",
                        to="globals.faculty",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="thesistopicprocess_member3",
                        to="globals.faculty",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="thesistopicprocess_supervisor",
                        to="globals.faculty",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="teachingcreditregistration_approved_course",
                        to="academic_information.curriculum",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="teachingcreditregistration_curr1",
                        to="academic_information.curriculum",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="teachingcreditregistration_curr2",
                        to="academic_information.curriculum",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="teachingcreditregistration_curr3",
                        to="academic_information.curriculum",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="teachingcreditregistration_curr4",
                        to="academic_information.curriculum",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="teachingcreditregistration_supervisor_id",
                        to="globals.faculty",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="programme_curriculum.semester",
                    ),
                ),
                (
                    "student_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "details",
                    models.FileField(
                        upload_to="academic_procedure/Uploaded_document/PhdProgressDetails/"
                    ),
                ),
                ...
                (
                    "continuation_enhancement_assistantship",
                    models.CharField(
                        choices=[
                            ("yes", "yes"),
                            ("no", "no"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        choices=[("Stu_paid", "Paid"), ("Stu_due", "Due")],
                        max_length=15,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="academic_information.course",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "working_year",
                    models.IntegerField(
                        blank=True, choices=[(2023, 2023), (2022, 2022)], null=True
                    ),
                ),
                (
                    "course_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "applicability",
                    models.CharField(
                        choices=[("GATE", "GATE"), ("NET", "NET"), ("CEED", "CEED")],
                        max_length=5,
                    ),
                ),
