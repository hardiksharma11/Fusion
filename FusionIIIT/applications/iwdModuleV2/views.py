...
def page1_1(request):
    if request.method == "POST":
        ...
        if (
            "technicalBidDate" in request.POST
            and request.POST["technicalBidDate"] != ""
        ):
            formObject.technicalBidDate = request.POST["technicalBidDate"]
        if (
            "financialBidDate" in request.POST
            and request.POST["financialBidDate"] != ""
        ):
...
def page2_1(request):
    if request.method == "POST":
        ...
        if (
            "qualifiedAgencies" in request.POST
            and request.POST["qualifiedAgencies"] != ""
        ):
...
def TechnicalBidForm(request):
    ...
    return render(
        request,
        "iwdModuleV2/page2_support_4_technicalbid.html",
...
def noOfEntriesFinancialBid(request):
    ...
    if request.method == "POST":
        ...
        for f in range(len(listOfContractors)):
            ...
            formContractorObject.totalCost = request.POST[
                listOfContractors[f] + "totalCost"
            ]
            formContractorObject.estimatedCost = request.POST[
                listOfContractors[f] + "estimatedCost"
            ]
            formContractorObject.percentageRelCost = request.POST[
                listOfContractors[f] + "percentageRelCost"
            ]
            formContractorObject.perFigures = request.POST[
                listOfContractors[f] + "perFigures"
            ]
            formContractorObject.save()
        return redirect("iwdModuleV2/letterOfIntent")
    return render(
        request,
        "iwdModuleV2/page2_support_5_financialbid.html",
...
def financialBidView(request):
    ...
    for f in objects:
        ...
        for w in contractorObjects:
            ...
            elements.append(obj)
    return render(
        request, "iwdModuleV2/Page2_financialbid.html", {"financial": elements}
    )
...
def technicalBidView(request):
    ...
    for f in objects:
        ...
        for w in contractorObjects:
            ...
            elements.append(obj)
    return render(
        request, "iwdModuleV2/Page2_technical-bid.html", {"technical": elements}
    )
...
def preBidDetailsView(request):
    ...
    return render(
        request, "iwdModuleV2/Page2_pre-bid.html", {"preBidDetails": preBidObjects}
    )
...
def corrigendumView(request):
    ...
    return render(
        request, "iwdModuleV2/corrigendum.html", {"corrigendum": corrigendumObject}
    )
...
def letterOfIntentView(request):
    ...
    return render(
        request, "iwdModuleV2/letterOfIntent.html", {"x": letterOfIntentObject}
    )
...
def milestoneView(request):
    ...
    return render(
        request, "iwdModuleV2/Page2_milestones.html", {"milestones": milestoneObjects}
    )
...
def extensionFormView(request):
    ...
    return render(
        request, "iwdModuleV2/ExtensionForm.html", {"extension": extensionObjects}
    )
