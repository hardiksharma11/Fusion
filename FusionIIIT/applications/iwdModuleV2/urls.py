...
urlpatterns = [
    ...
    url(
        r"noOfEntriesTechnicalBid/$",
        views.noOfEntriesTechnicalBid,
        name="IWD Technical Bid",
    ),
    url(
        r"noOfEntriesFinancialBid/$",
        views.noOfEntriesFinancialBid,
        name="IWD Financial Bid",
    ),
