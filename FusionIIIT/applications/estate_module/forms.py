...
class BuildingForm(ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            "name": TextInput(attrs={"placeholder": "Enter name of building"}),
            ...
            "dateConstructionStarted": DateInput(
                attrs={
                    "placeholder": "Enter date",
                    # 'type': 'date',
                }
            ),
            "dateConstructionCompleted": DateInput(
                attrs={
                    "placeholder": "Enter date",
                    # 'type': 'date',
                }
            ),
            "dateOperational": DateInput(
                attrs={
                    "placeholder": "Enter date",
                    # 'type': 'date',
                }
            ),
            "area": NumberInput(attrs={"placeholder": "Enter area", "type": "text"}),
            "constructionCostEstimated": NumberInput(
                attrs={
            ...
            "constructionCostActual": NumberInput(
                attrs={
                    "placeholder": "Enter actual construction cost",
                    "type": "text",  # made type=text because semantic UI's optional form validation doesn't work on type=number
                }
            ),
            "numRooms": NumberInput(
                attrs={
                    "placeholder": "Enter number of rooms",
                    "type": "text",  # made type=text because semantic UI's optional form validation doesn't work on type=number
                }
            ),
            "numWashrooms": NumberInput(
                attrs={
                    "placeholder": "Enter number of washrooms",
                    "type": "text",  # made type=text because semantic UI's optional form validation doesn't work on type=number
                }
            ),
            "remarks": Textarea(attrs={"placeholder": "Enter remarks"}),
            "verified": CheckboxInput({"placeholder": "Verified"}),
        }
        labels = {
            "name": "Building name",
    ...
    def clean(self):
        ...
        if (
            dateIssued != None
            and dateConstructionStarted != None
            and dateIssued > dateConstructionStarted
        ):
            self._errors["dateConstructionStarted"] = self.error_class(
                ["Construction date must be after issue date"]
            )
        if (
            dateConstructionCompleted != None
            and dateConstructionStarted != None
            and dateConstructionStarted >= dateConstructionCompleted
        ):
        ...
        if (
            dateConstructionCompleted != None
            and dateOperational != None
            and dateConstructionStarted >= dateOperational
        ):
...
class WorkForm(ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            "name": TextInput(attrs={"placeholder": "Enter name of work"}),
            "contractorName": TextInput(
                attrs={"placeholder": "Enter name of contractor"}
            ),
            "dateIssued": DateInput(
                attrs={
                    "placeholder": "Enter date",
            ...
            "costEstimated": NumberInput(
                attrs={
                    "placeholder": "Enter estimated construction cost",
                    "type": "text",
                }
            ),
            "costActual": NumberInput(
                attrs={"placeholder": "Enter actual construction cost", "type": "text"}
            ),
            "remarks": Textarea(attrs={"placeholder": "Enter remarks"}),
        }
        labels = {
...
class InventoryTypeForm(ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            "name": TextInput(attrs={"placeholder": "Enter name of Inventory Type"}),
            "manufacturer": TextInput(
                attrs={"placeholder": "Enter name of manufacturer"}
            ),
            "model": TextInput(attrs={"placeholder": "Enter model name/number"}),
            "rate": NumberInput(attrs={"placeholder": "Enter rate (cost per unit)"}),
            "remarks": Textarea(attrs={"placeholder": "Enter remarks"}),
        }
        labels = {
            "name": "Inventory name",
...
class InventoryConsumableForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "presentQuantity": NumberInput(
                attrs={
                    "placeholder": "Enter present quantity",
                    "type": "text",
                }
            ),
            "dateOrdered": DateInput(
                attrs={
                    "placeholder": "Enter date",
                }
            ),
...
class InventoryNonConsumableForm(ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            "serial_no": TextInput(attrs={"placeholder": "Enter Serial Number"}),
            "quantity": NumberInput(
                attrs={
                    "placeholder": "Enter quantity",
                    "type": "text",
