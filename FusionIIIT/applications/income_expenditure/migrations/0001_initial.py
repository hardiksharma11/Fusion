    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "receipt",
                    models.FileField(blank=True, upload_to="iemodule/income_receipts"),
                ),
                (
                    "source",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="incomeSource",
                        to="income_expenditure.incomesource",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expenditure_receipt",
                    models.FileField(upload_to="iemodule/expenditure_receipts"),
                ),
                (
                    "spent_on",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="expenditureType",
                        to="income_expenditure.expendituretype",
                    ),
                ),
            ],
        ),
