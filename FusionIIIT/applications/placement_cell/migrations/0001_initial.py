        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "debar",
                    models.CharField(
                        choices=[("NOT DEBAR", "Not Debar"), ("DEBAR", "Debar")],
                        default="NOT DEBAR",
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attached_file",
                    models.FileField(
                        blank=True, null=True, upload_to="documents/placement/schedule"
                    ),
                ),
                (
                    "schedule_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="placement_cell.notifystudent",
                    ),
                ),
                (
                    "role",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "achievement_type",
                    models.CharField(
                        choices=[("EDUCATIONAL", "Educational"), ("OTHER", "Other")],
                        default="OTHER",
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="placement_cell.placementrecord",
                    ),
                ),
                (
                    "unique_id",
