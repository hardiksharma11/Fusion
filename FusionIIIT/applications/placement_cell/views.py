...
def get_reference_list(request):
    if request.method == "POST":
        ...
        print(student)
        reference_objects = Reference.select_related("unique_id").objects.filter(
            unique_id=student
        )
        reference_objects = serializers.serialize("json", list(reference_objects))

        context = {"reference_objs": reference_objects}
...
def company_name_dropdown(request):
    if request.method == "POST":
        ...
        company_names = CompanyDetails.objects.filter(
        ...
        context = {"company_names": company_name}
...
def placement(request):
    ...
    if current:
        ...
        if request.method == "POST":
            if "studentapprovesubmit" in request.POST:
                status = (
                    ...
                    .filter(pk=request.POST["studentapprovesubmit"])
                    .update(invitation="ACCEPTED", timestamp=timezone.now())
                )
            if "studentdeclinesubmit" in request.POST:
                status = (
                    PlacementStatus.objects.select_related("unique_id", "notify_id")
                    .filter(Q(pk=request.POST["studentdeclinesubmit"]))
                    .update(invitation="REJECTED", timestamp=timezone.now())
                )
            ...
            if "educationsubmit" in request.POST:
                ...
                if form.is_valid():
                    ...
                    education_obj = Education.objects.select_related(
                        "unique_id"
                    ).create(
                        unique_id=student,
                        degree=degree,
            ...
            if "skillsubmit" in request.POST:
                ...
                if form.is_valid():
                    ...
                    has_obj = Has.objects.select_related(
                        "skill_id", "unique_id"
                    ).create(
                        unique_id=student,
            ...
            if "achievementsubmit" in request.POST:
                ...
                if form.is_valid():
                    ...
                    achievement_obj = Achievement.objects.select_related(
                        "unique_id"
                    ).create(
                        unique_id=student,
            ...
            if "publicationsubmit" in request.POST:
                ...
                if form.is_valid():
                    ...
                    publication_obj = Publication.objects.select_related(
                        "unique_id"
                    ).create(
                        unique_id=student,
            ...
            if "experiencesubmit" in request.POST:
                ...
                if form.is_valid():
                    ...
                    sdate = form.cleaned_data["sdate"]
                    edate = form.cleaned_data["edate"]
                    experience_obj = Experience.objects.select_related(
                        "unique_id"
                    ).create(
                        unique_id=student,
                        title=title,
        ...
        placementschedule = (
            PlacementSchedule.objects.select_related("notify_id")
            .filter(Q(placement_date__gte=date.today()))
            .values_list("notify_id", flat=True)
        )

        placementstatus = (
            PlacementStatus.objects.select_related("unique_id", "notify_id")
            .filter(Q(unique_id=student, notify_id__in=placementschedule))
            .order_by("-timestamp")
        )
    ...
    if "deletesch" in request.POST:
        ...
        try:
            placement_schedule = PlacementSchedule.objects.select_related(
                "notify_id"
            ).get(pk=delete_sch_key)
...
def invitation_status(request):
    ...
    if "studentplacementsearchsubmit" in request.POST:
        ...
        if form.is_valid():
            ...
            placementstatus_placement = PlacementStatus.objects.select_related(
                "unique_id", "notify_id"
            ).filter(
                Q(
                                ...
                                Q(
                                    id__in=ExtraInfo.objects.filter(
                                        Q(
                                            user__in=User.objects.filter(
                                                Q(
                                                    first_name__icontains=request.session[
                                                        "mn_stuname"
                                                    ]
                                                )
                                            ),
    ...
    if "studentpbisearchsubmit" in request.POST:
        ...
        if request.GET.get("pbi_page") != None:
            ...
            no_pagination = 1
            try:
                placementstatus_pbi = PlacementStatus.objects.select_related(
                    "unique_id", "notify_id"
                ).filter(
                    Q(
                        notify_id__in=NotifyStudent.objects.filter(
    ...
    if "pdf_gen_invitation_status" in request.POST:
        ...
        if "pdf_gen_invitation_status_placement" in request.POST:
            ...
            placementstatus = PlacementStatus.objects.select_related(
                "unique_id", "notify_id"
            ).filter(
                Q(
                    notify_id__in=NotifyStudent.objects.filter(
        ...
        context = {"placementstatus": placementstatus}
                    ...
                    students = (
                        Student.objects.filter(
                            Q(
                                ...
                                cpi__gte=decimal.Decimal(request.session["cpi"]),
                            )
                        )
                        .filter(
                            Q(
            ...
            if form13.is_valid():
                if form13.cleaned_data["company"]:
                    ...
                    students = Student.objects.filter(
                        ...
                        id__in=PlacementStatus.objects.select_related(
                            "unique_id", "notify_id"
                        )
...
def manage_records(request):
    ...
    years = (
        PlacementRecord.objects.filter(~Q(placement_type="HIGHER STUDIES"))
        .values("year")
        .annotate(Count("year"))
    )
    ...
    try:
        ...
        if "studenthigheraddsubmit" in request.POST:
            ...
            if form.is_valid():
                ...
                studentr = StudentRecord.objects.select_related(
                    "unique_id", "record_id"
                ).create(
        ...
        if "studentpbiaddsubmit" in request.POST:
            ...
            if form.is_valid():
                ...
                placementr = PlacementRecord.objects.create(
                    year=year, ctc=ctc, placement_type="PBI", name=cname
                )
                studentr = StudentRecord.objects.select_related(
                    "unique_id", "record_id"
                ).create(
        ...
        if "studentplacementaddsubmit" in request.POST:
            ...
            if form.is_valid():
                ...
                cname = form.cleaned_data["cname"]
                placementr = PlacementRecord.objects.create(
                    year=year, ctc=ctc, placement_type="PLACEMENT", name=cname
                )
                studentr = StudentRecord.objects.select_related(
                    "unique_id", "record_id"
                ).create(
        ...
        if "studentplacementrecordsubmit" in request.POST:
            ...
            if form.is_valid():
                ...
                if form.cleaned_data["year"]:
                    ...
                    placementrecord = (
                        StudentRecord.objects.select_related("unique_id", "record_id")
                        .select_related("unique_id", "record_id")
                        .filter(
                            Q(
                                record_id__in=PlacementRecord.objects.filter(
                                    Q(
                                        placement_type="PLACEMENT",
                                        name__icontains=cname,
                                        ctc__gte=ctc,
                    ...
                    placementrecord = StudentRecord.objects.select_related(
                        "unique_id", "record_id"
                    ).filter(
                        Q(
                            record_id__in=PlacementRecord.objects.filter(
        ...
        if "studentpbirecordsubmit" in request.POST:
            ...
            if form.is_valid():
                ...
                if form.cleaned_data["year"]:
                    year = form.cleaned_data["year"]
                    pbirecord = StudentRecord.objects.select_related(
                        "unique_id", "record_id"
                    ).filter(
                        Q(
                            record_id__in=PlacementRecord.objects.filter(
        ...
        if "studenthigherrecordsubmit" in request.POST:
            ...
            if form.is_valid():
                ...
                if form.cleaned_data["year"]:
                    year = form.cleaned_data["year"]
                    higherrecord = StudentRecord.objects.select_related(
                        "unique_id", "record_id"
                    ).filter(
                        Q(
                            record_id__in=PlacementRecord.objects.filter(
                        ...
                        higherrecord = StudentRecord.objects.select_related(
                            ...
                            Q(
                                record_id__in=PlacementRecord.objects.filter(
                                    Q(
                                        placement_type="HIGHER STUDIES",
                                        test_type__icontains=request.session[
                                            "test_type"
                                        ],
        ...
        messages.error(
            request, "Problem Occurred!!! Please Try Again with Correct Info!!"
        )
        print(e)
            ...
            if r["year"] == y["year"]:
                if r["placement_type"] != "HIGHER STUDIES":
                    for z in studentrecord:
                        if (
                            z.record_id.name == r["name"]
                            and z.record_id.year == r["year"]
                            and z.unique_id.id.department.name == "CSE"
                        ):
                        ...
                        if (
                            z.record_id.name == r["name"]
                            and z.record_id.year == r["year"]
                            and z.unique_id.id.department.name == "ECE"
                        ):
                        ...
                        if (
                            z.record_id.name == r["name"]
                            and z.record_id.year == r["year"]
                            and z.unique_id.id.department.name == "ME"
                        ):
                                    ...
                                    Q(
                                        user__in=User.objects.filter(
                                            Q(
                                                ...
                                                last_name__icontains=request.session[
                                                    "last_name"
                                                ],
                                            )
                                        ),
...
def export_to_xls_invitation_status(qs):
    ...
    for student in qs:
        ...
        row.append(
            student.unique_id.id.user.first_name
            + " "
            + student.unique_id.id.user.last_name
        )
