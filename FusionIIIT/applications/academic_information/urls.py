...
urlpatterns = [
    ...
    url(
        r"^deleteConvenor/(?P<pk>[0-9]+)$", views.deleteConvenor, name="deleteConvenor"
    ),
    ...
    url(
        r"^add_advanced_profile",
        views.add_advanced_profile,
    ...
    url(
        r"^delete_advanced_profile",
        views.delete_advanced_profile,
        name="delete_advanced_profile",
    ),
    url(
        r"^delete_basic_profile/(?P<pk>[0-9]+)$",
        views.delete_basic_profile,
    ...
    url(
        r"^generate_preregistration_report",
        views.generate_preregistration_report,
    ...
    url(
        r"^view_all_student_data",
        views.view_all_student_data,
        name="view_all_student_data",
    ),
    url(
        r"^generateStudentSheet$",
        views.generatestudentxlsheet,
        name="generatestudentxlsheet",
    ),
]
