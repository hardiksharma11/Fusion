...
class DeanS_approve_committes(models.Model):
    ...
    convener = models.ForeignKey(
        ExtraInfo, on_delete=models.CASCADE, related_name="convener"
    )
    faculty_incharge = models.ForeignKey(
        ExtraInfo, on_delete=models.CASCADE, related_name="facultyincharge"
    )
...
class hostel_guestroom_approval(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=Constants.APPROVAL_TYPE, default="Pending"
    )
