    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.IntegerField(choices=[("0", "unseen"), ("1", "seen")]),
                ),
                ("file", models.FileField(upload_to="")),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item_type",
                    models.IntegerField(
                        choices=[("0", "Non-consumable"), ("1", "Consumable")],
                        default="0",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "department",
                    models.CharField(
                        choices=[("civil", "civil"), ("electrical", "electrical")],
                        max_length=50,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="office_module.registrar_create_doc",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "approval",
                    models.IntegerField(
                        choices=[("0", "reject"), ("1", "accept")], default=0
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "project_operated",
                    models.CharField(
                        choices=[("PI", "Only by PI"), ("any", "Either PI or CO-PI")],
                        default="me",
                        max_length=50,
                    ),
                ),
                ...
                (
                    "HOD_response",
                    models.CharField(
                        choices=[("Forwarded", "Forwarded"), ("Pending", "Pending")],
                        default="Pending",
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="office_module.project_registration",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="globals.designation",
                    ),
                ),
                (
                    "leave",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="leave.leave"
                    ),
                ),
                (
                    "name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="office_module.teaching_credits1",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="academic_information.meeting",
                    ),
                ),
                (
                    "member_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="academic_information.curriculum_instructor",
                    ),
                ),
                (
                    "student_id",
