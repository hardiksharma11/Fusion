...
def programme_curriculum(request):
    ...
    if (
        str(des.designation) == "student"
        or str(des.designation) == "Associate Professor"
...
def view_all_programmes(request):
    ...
    return render(
        request,
        "programme_curriculum/view_all_programmes.html",
        {"ug": ug, "pg": pg, "phd": phd},
    )
...
def view_curriculums_of_a_programme(request, programme_id):
    ...
    return render(
        request,
        "programme_curriculum/view_curriculums_of_a_programme.html",
        {
            "program": program,
            "past_curriculums": past_curriculums,
            "working_curriculums": working_curriculums,
...
def view_all_working_curriculums(request):
    ...
    return render(
        request,
        "programme_curriculum/view_all_working_curriculums.html",
        {"curriculums": curriculums, "curriculumfilter": curriculumfilter},
    )
...
def view_semesters_of_a_curriculum(request, curriculum_id):
    ...
    return render(
        request,
        "programme_curriculum/view_semesters_of_a_curriculum.html",
        {
            "curriculum": curriculum,
            "semesters": semesters,
            "semester_slots": transpose_semester_slots,
...
def view_a_semester_of_a_curriculum(request, semester_id):
    ...
    return render(
        request,
        "programme_curriculum/view_a_semester_of_a_curriculum.html",
        {"semester": semester, "course_slots": course_slots},
    )
...
def view_a_courseslot(request, courseslot_id):
    ...
    return render(
        request,
        "programme_curriculum/view_a_courseslot.html",
...
def view_all_courses(request):
    ...
    return render(
        request,
        "programme_curriculum/view_all_courses.html",
        {"courses": courses, "coursefilter": coursefilter},
    )
...
def view_a_course(request, course_id):
    ...
    return render(
        request, "programme_curriculum/view_a_course.html", {"course": course}
    )
...
def view_all_discplines(request):
    ...
    return render(
        request,
        "programme_curriculum/view_all_disciplines.html",
...
def view_all_batches(request):
    ...
    return render(
        request,
        "programme_curriculum/view_all_batches.html",
        {
            "batches": batches,
...
def admin_view_all_programmes(request):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_all_programmes.html",
        {"ug": ug, "pg": pg, "phd": phd},
    )
...
def admin_view_curriculums_of_a_programme(request, programme_id):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_curriculums_of_a_programme.html",
        {
            "program": program,
            "past_curriculums": past_curriculums,
            "working_curriculums": working_curriculums,
...
def admin_view_all_working_curriculums(request):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_all_working_curriculums.html",
        {"curriculums": curriculums, "curriculumfilter": curriculumfilter},
    )
...
def admin_view_semesters_of_a_curriculum(request, curriculum_id):
    ...
    all_batches = (
        ...
        .exclude(curriculum=curriculum_id)
        .order_by("year")
    )

    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_semesters_of_a_curriculum.html",
        {
            "curriculum": curriculum,
            "semesters": semesters,
            "semester_slots": transpose_semester_slots,
...
def admin_view_a_semester_of_a_curriculum(request, semester_id):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_a_semester_of_a_curriculum.html",
        {"semester": semester, "course_slots": course_slots},
    )
...
def admin_view_a_courseslot(request, courseslot_id):
    ...
    if edit == course_slot.id:
        return render(
            request,
            "programme_curriculum/acad_admin/admin_edit_semesters_view_a_courseslot.html",
            {"course_slot": course_slot},
        )

    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_a_courseslot.html",
        {"course_slot": course_slot},
    )
...
def admin_view_all_courses(request):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_all_courses.html",
        {"courses": courses, "coursefilter": coursefilter},
    )
...
def admin_view_a_course(request, course_id):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_a_course.html",
        {"course": course},
    )
...
def admin_view_all_discplines(request):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_all_disciplines.html",
        {"disciplines": disciplines},
    )
...
def admin_view_all_batches(request):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/admin_view_all_batches.html",
        {
            "batches": batches,
            "finished_batches": finished_batches,
            "batchfilter": batchfilter,
...
def add_discipline_form(request):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/add_discipline_form.html",
        {"form": form},
    )
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                return HttpResponseRedirect(
                    "/programme_curriculum/admin_curriculums/" + str(programme.id) + "/"
                )
    return render(
        request,
        "programme_curriculum/acad_admin/add_programme_form.html",
...
def add_curriculum_form(request):
            ...
            if form.is_valid():
                ...
                for semester_no in range(1, no_of_semester + 1):
                    NewSemester = Semester(
                        curriculum=curriculum, semester_no=semester_no
                    )
                    NewSemester.save()

                messages.success(request, "Added successful")
                return HttpResponseRedirect(
                    "/programme_curriculum/admin_curriculum_semesters/"
                    + str(curriculum.id)
                    + "/"
                )
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/add_curriculum_form.html",
        {"form": form, "submitbutton": submitbutton},
    )
    ...
    if submitbutton:
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                old_no_of_semester = Semester.objects.filter(
                    curriculum=curriculum
                ).count()
                if old_no_of_semester != no_of_semester:

                    if old_no_of_semester > no_of_semester:
                        for semester_no in range(
                            no_of_semester + 1, old_no_of_semester + 1
                        ):
                            try:
                                OldSemester = Semester.objects.filter(
                                    curriculum=curriculum
                                ).filter(semester_no=semester_no)
                                OldSemester.delete()
                            except:
                        ...
                        for semester_no in range(
                            max(1, old_no_of_semester), no_of_semester + 1
                        ):
                            try:
                                NewSemester = Semester(
                                    curriculum=curriculum, semester_no=semester_no
    ...
    if submitbutton:
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                messages.success(request, "Added successful")
                return HttpResponseRedirect(
                    "/programme_curriculum/admin_course/" + str(course.id) + "/"
                )

    return render(
        request, "programme_curriculum/acad_admin/add_course_form.html", {"form": form}
    )
...
def update_course_form(request, course_id):
    ...
    if (
        str(des.designation) == "student"
    ):  # or str(des.designation) == "Associate Professor" or str(des.designation) == "Professor" or str(des.designation) == "Assistant Professor"
        return HttpResponseRedirect("/programme_curriculum/programmes/")
    elif str(request.user) == "acadadmin":
        pass
    ...
    if submitbutton:
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                return HttpResponseRedirect(
                    "/programme_curriculum/admin_course/" + str(course_id) + "/"
                )

    return render(
        request,
        "programme_curriculum/acad_admin/add_course_form.html",
        {"course": course, "form": form, "submitbutton": submitbutton},
    )
    ...
    if submitbutton:
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                return HttpResponseRedirect(
                    "/programme_curriculum/admin_curriculum_semesters/"
                    + str(courseslot.semester.curriculum.id)
                    + "/"
                )
    return render(
        request,
        "programme_curriculum/acad_admin/add_courseslot_form.html",
        {"form": form, "submitbutton": submitbutton, "curriculum_id": curriculum_id},
    )
    ...
    if submitbutton:
        if request.method == "POST":
            ...
            if form.is_valid():
                form.save()
                messages.success(
                    request, "Updated " + str(courseslot.name) + " successful"
                )
                return HttpResponseRedirect(
                    "/programme_curriculum/admin_curriculum_semesters/"
                    + str(courseslot.semester.curriculum.id)
...
def add_batch_form(request):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/add_batch_form.html",
        {"form": form, "submitbutton": submitbutton},
    )
...
def edit_batch_form(request, batch_id):
    ...
    return render(
        request,
        "programme_curriculum/acad_admin/add_batch_form.html",
        {"batch": batch, "form": form, "submitbutton": submitbutton},
    )
...
def instigate_semester(request, semester_id):
    ...
    form = SemesterForm(
        initial={
            "start_semester": sdate,
            "end_semester": edate,
            "instigate_semester": isem,
            "semester_info": info,
        }
    )
    ...
    if submitbutton:
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                return HttpResponseRedirect(
                    "/programme_curriculum/admin_curriculum_semesters/"
                    + str(semester.curriculum.id)
                    + "/"
                )

    return render(
        request,
        "programme_curriculum/acad_admin/instigate_semester_form.html",
        {
            "semester": semester,
            "form": form,
            "submitbutton": submitbutton,
