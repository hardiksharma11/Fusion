...
class ProgrammeForm(ModelForm):
    class Meta:
        ...
        labels = {"category": "Programme Category", "name": "Programme Name"}
...
class DisciplineForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "programmes": forms.SelectMultiple(
                attrs={
                    "class": "ui fluid search selection dropdown",
                }
            ),
            "acronym": forms.TextInput(
                attrs={"placeholder": "xxx", "max_length": 10, "class": "field"}
            ),
        }
        labels = {
    ...
    class Meta:
        ...
        widgets = {
            ...
            "version": forms.NumberInput(
                attrs={"placeholder": "Enter the latest version", " class": "field"},
            ),
            "working_curriculum": forms.CheckboxInput(attrs={"class": "ui checkbox"}),
            "no_of_semester": forms.NumberInput(
                attrs={
                    "placeholder": "Enter the number of semesters",
                    " class": "field",
                },
            ),
            "min_credit": forms.NumberInput(
                attrs={"placeholder": "Minimum Number of Credits", " class": "field"},
            ),
        }
        labels = {
...
class ReplicateCurriculumForm(ModelForm):
    ...
    working_curriculum = forms.BooleanField(
        widget=forms.CheckboxInput(attrs={"class": "ui checkbox"}),
    )
    no_of_semester = forms.IntegerField(
        widget=forms.NumberInput(
            attrs={"placeholder": "Enter the number of semesters", " class": "field"},
        ),
    )
    min_credit = forms.IntegerField(
        widget=forms.NumberInput(
            attrs={"placeholder": "Minimum Number of Credits", " class": "field"},
        ),
    )
...
class SemesterForm(forms.Form):
    ...
    start_semester = forms.DateField(
        required=False,
        widget=forms.DateInput(attrs={"placeholder": "Start"}),
        label="Semester Start Date",
    )
    end_semester = forms.DateField(
        required=False,
        widget=forms.DateInput(attrs={"placeholder": "End"}),
        label="Semester End Date",
    )
    instigate_semester = forms.NullBooleanField(
        required=False,
        widget=forms.CheckboxInput(attrs={"tabindex": "0", "class": "hidden"}),
        label="Instigate This Semester",
    )
    semester_info = forms.CharField(
        required=False,
        widget=forms.Textarea(attrs={"placeholder": "Semester Information"}),
    )
...
class CourseForm(ModelForm):
    ...
    def clean(self):
        ...
        if percentages_sum != 100:
            msg = (
                "Percentages must add up to 100%, they currently add up to "
                + str(percentages_sum)
                + "%"
            )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "lecture_hours": forms.NumberInput(
                attrs={
                    "placeholder": "Lecture hours",
                },
            ),
            "tutorial_hours": forms.NumberInput(
                attrs={
                    "placeholder": "Tutorial hours",
                },
            ),
            "pratical_hours": forms.NumberInput(
                attrs={
                    "placeholder": "Practical hours",
                },
            ),
            "discussion_hours": forms.NumberInput(
                attrs={
                    "placeholder": "Group Discussion hours",
                },
            ),
            "project_hours": forms.NumberInput(
                attrs={
                    "placeholder": "Project hours",
                },
            ),
            "working_course": forms.CheckboxInput(attrs={"class": "ui checkbox"}),
            "disciplines": forms.SelectMultiple(
                attrs={
                    "class": "ui fluid search selection dropdown",
                }
            ),
            "pre_requisits": forms.Textarea(
                attrs={"placeholder": "Text", "class": "field"}
            ),
            "pre_requisit_courses": forms.SelectMultiple(
                attrs={
                    "class": "ui fluid search selection dropdown",
                }
            ),
            "syllabus": forms.Textarea(attrs={"placeholder": "Text", "class": "field"}),
            "ref_books": forms.Textarea(
                attrs={"placeholder": "Text", "class": "field"}
            ),
            "percent_quiz_1": forms.NumberInput(
                attrs={"placeholder": "%"},
            ),
            "percent_midsem": forms.NumberInput(
                attrs={"placeholder": "%"},
            ),
            "percent_quiz_2": forms.NumberInput(
                attrs={"placeholder": "%"},
            ),
            "percent_endsem": forms.NumberInput(
                attrs={"placeholder": "%"},
            ),
            "percent_project": forms.NumberInput(
                attrs={"placeholder": "%"},
            ),
            "percent_lab_evaluation": forms.NumberInput(
                attrs={"placeholder": "%"},
            ),
            "percent_course_attendance": forms.NumberInput(
                attrs={"placeholder": "%"},
            ),
        }
        labels = {
    ...
    class Meta:
        ...
        widgets = {
            ...
            "year": forms.NumberInput(
                attrs={"placeholder": "Enter Batch Year", "class": "field"}
            ),
...
class CourseSlotForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "name": forms.TextInput(
                attrs={"placeholder": "Name/Code", "max_length": 100, "class": "field"}
            ),
            "type": forms.Select(
                attrs={"class": "ui fluid search selection dropdown"},
            ),
            "course_slot_info": forms.Textarea(
                attrs={
            ...
            "duration": forms.NumberInput(
                attrs={
                    "placeholder": "Semester Duration of Course/Project",
                },
            ),
            "min_registration_limit": forms.NumberInput(
                attrs={
                    "placeholder": "Minimum Course Slot Reg limit",
                },
            ),
            "max_registration_limit": forms.NumberInput(
                attrs={
                    "placeholder": "Maximum Course Slot Reg limit",
                },
            ),
        }
        labels = {
