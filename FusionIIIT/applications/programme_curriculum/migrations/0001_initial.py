    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="programme_curriculum.curriculum",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="programme_curriculum.Programme"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="programme_curriculum.programme",
            ),
        ),
        migrations.CreateModel(
            name="Course",
            fields=[
                ...
                (
                    "disciplines",
                    models.ManyToManyField(
                        blank=True, to="programme_curriculum.Discipline"
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="_course_pre_requisit_courses_+",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "courses",
                    models.ManyToManyField(
                        blank=True, to="programme_curriculum.Course"
                    ),
                ),
                (
                    "semester",
