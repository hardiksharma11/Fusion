    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "club_website",
                    models.CharField(default="hello", max_length=150, null=True),
                ),
                (
                    "category",
                    models.CharField(
                ...
                (
                    "club_file",
                    models.FileField(null=True, upload_to="gymkhana/club_poster"),
                ),
                (
                    "activity_calender",
                    models.FileField(
                        default=" ", null=True, upload_to="gymkhana/activity_calender"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "roll",
                    models.CharField(
                        default=2016001, max_length=7, primary_key=True, serialize=False
                    ),
                ),
                ("status", models.BooleanField(default=True, max_length=5)),
                (
                    "form_name",
                    models.CharField(default="senate_registration", max_length=30),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("Classroom", (("CR101", "CR101"), ("CR102", "CR102"))),
                            ("Lecturehall", (("L101", "L101"), ("L102", "L102"))),
                        ],
                        max_length=50,
                    ),
                ),
                ...
                (
                    "session_poster",
                    models.ImageField(null=True, upload_to="gymkhana/session_poster"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event_poster",
                    models.FileField(blank=True, upload_to="gymkhana/event_poster"),
                ),
                ("details", models.TextField(max_length=256, null=True)),
                (
                    "status",
