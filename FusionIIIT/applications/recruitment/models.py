...
class PersonalDetails(models.Model):
    ...
    specialization = models.CharField(
        max_length=10, choices=Constants.SPECIALIZATION_CHOICES
    )
...
class AcademicDetails(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE)
    Xth = models.OneToOneField(
        EducationalDetails, on_delete=models.CASCADE, related_name="Xth_details"
    )
    XIIth = models.OneToOneField(
        EducationalDetails, on_delete=models.CASCADE, related_name="XIIth_details"
    )
    graduation = models.OneToOneField(
        EducationalDetails, on_delete=models.CASCADE, related_name="graduation_details"
    )
    post_graduation = models.OneToOneField(
        EducationalDetails,
        on_delete=models.CASCADE,
        related_name="post_graduations_details",
    )
    phd = models.OneToOneField(
        EducationalDetails, on_delete=models.CASCADE, related_name="phd_details"
    )
