        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "job_type",
                    models.CharField(
                        choices=[("T", "Teaching"), ("NT", "Non-Teaching")],
                        max_length=15,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "marital_status",
                    models.CharField(
                        choices=[("M", "Married"), ("U", "Unmarried")], max_length=10
                    ),
                ),
                ...
                (
                    "specialization",
                    models.CharField(
                        choices=[("MA", "Major"), ("MI", "Minor")], max_length=10
                    ),
                ),
                (
                    "category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="XIIth_details",
                        to="recruitment.educationaldetails",
                    ),
                ),
                (
                    "Xth",
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="graduation_details",
                        to="recruitment.educationaldetails",
                    ),
                ),
                (
