...
urlpatterns = [
    ...
    url(
        r"^startmessregistration/",
        views.start_mess_registration,
        name="startmessregistration",
    ),
    ...
    url(
        r"^(?P<ap_id>[0-9]+)/responsevacationfood/",
        views.response_vacation_food,
        name="responsevacationfood",
    ),
    ...
    url(
        r"^removemesscommittee", views.remove_mess_committee, name="removemesscommittee"
    ),
    url(r"^rebateresponse", views.rebate_response, name="rebateresponse"),
    url(
        r"^specialrequestresponse",
        views.special_request_response,
        name="specialrequestresponse",
    ),
