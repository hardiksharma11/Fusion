...
LEAVE_TYPE = (("casual", "Casual"), ("vacation", "Vacation"))
...
INTERVAL = (("Breakfast", "Breakfast"), ("Lunch", "Lunch"), ("Dinner", "Dinner"))

MESS_OPTION = (("mess1", "Veg_mess"), ("mess2", "Non_veg_mess"))
...
class Nonveg_menu(models.Model):
    ...
    order_interval = models.CharField(
        max_length=20, choices=INTERVAL, default="Breakfast"
    )
