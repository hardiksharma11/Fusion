...
def about(request):
    ...
    context = {
        ...
        "qaTeam": {
            "dev1": {
                "devName": "Anuj Upadhaya",
                "devImage": "zlatan.jpg",
                "devTitle": "Member",
            },
            "dev2": {
                "devName": "Avinash Kumar",
        ...
        "academics_a_Team": {
            ...
            "dev2": {
                "devName": "Achint Mistry",
                "devImage": "zlatan.jpg",
                "devTitle": "2015009",
            },
            "dev3": {
                "devName": "Harshit Choubey",
                "devImage": "team/2015103.jpeg",
                "devTitle": "2015103",
            },
            "dev4": {"devName": "", "devImage": "zlatan.jpg", "devTitle": "Rollnum"},
        },
        "academics_b_Team": {
            "dev1": {
                "devName": "Mayank Saurabh",
                "devImage": "team/2015153.jpg",
                "devTitle": "UI Developer",
            },
            "dev2": {
                "devName": "Narosenla Longkumer",
                "devImage": "team/2015165.jpg",
                "devTitle": "2015165",
            },
            "dev3": {
                "devName": "Rambha Sirisha",
                "devImage": "team/2015203.jpg",
                "devTitle": "2015203",
            },
            "dev4": {"devName": "", "devImage": "zlatan.jpg", "devTitle": "2015"},
            "dev5": {"devName": "", "devImage": "zlatan.jpg", "devTitle": "2015"},
        },
        "complaintTeam": {
            "dev1": {
                "devName": "Kanishka Munshi",
            ...
            "dev2": {
                "devName": "Amresh Kumar Verma",
                "devImage": "zlatan.jpg",
                "devTitle": "2015027",
            },
            "dev3": {
                "devName": "Rishti Gupta",
                "devImage": "zlatan.jpg",
                "devTitle": "2015209",
            },
            "dev4": {
                "devName": "Shubham Yadav",
                "devImage": "team/2015248.jpg",
                "devTitle": "2015248",
            },
            "dev5": {"devName": "", "devImage": "zlatan.jpg", "devTitle": ""},
        },
        "eisTeam": {
            "dev1": {
                "devName": "Kanishka Munshi",
        ...
        "filetrackingTeam": {
            ...
            "dev2": {
                "devName": "Deepak Chhipa",
                "devImage": "team/2015076.jpg",
                "devTitle": "2015076",
            },
            "dev3": {"devName": "", "devImage": "zlatan.jpg", "devTitle": "2015"},
            "dev4": {"devName": "", "devImage": "zlatan.jpg", "devTitle": "2015"},
            "dev5": {"devName": "", "devImage": "zlatan.jpg", "devTitle": "2015"},
        },
        "gymkhanaTeam": {
        ...
        "messTeam": {
            ...
            "dev2": {
                "devName": "Ankita Makker",
                "devImage": "team/2015034.jpg",
                "devTitle": "2015034",
            },
            "dev3": {
                "devName": "K. Venkateshwar Reddy",
                "devImage": "team/2015117.jpg",
                "devTitle": "2015117",
            },
            "dev4": {
                "devName": "Pratibha Singh",
                "devImage": "team/2015189.jpg",
                "devTitle": "2015189",
            },
            "dev5": {
                "devName": "Varnika Jain",
        ...
        "phcTeam": {
            ...
            "dev4": {
                "devName": "K. Sai Srikar",
                "devImage": "team/2015127.jpg",
                "devTitle": "2015127",
            },
            "dev5": {
                "devName": "Priyanka Agarwal",
        ...
        "spacsTeam": {
            ...
            "dev2": {
                "devName": "Atla Shashidhar Reddy",
                "devImage": "team/2015056.jpeg",
                "devTitle": "2015056",
            },
            "dev3": {
                "devName": "Gopisetti Pramod Kumar",
...
def about(request):
    ...
    context = {
        ...
        "CourseManagementTeam": {
            "dev1": {
                "devName": "Animesh Pandey",
                "devImage": "zlatan.jpg",
                "devTitle": "Developer",
            },
            "dev2": {
                "devName": "Paras Rastogi",
                "devImage": "zlatan.jpg",
                "devTitle": "Developer",
            },
        },
...
def profile(request, username=None):
    ...
    ).filter(Q(working=user, designation__name="student"))
    if current:
        ...
        if editable and request.method == "POST":
            ...
            if "skillsubmit" in request.POST:
                ...
                if form.is_valid():
                    ...
                    has_obj = Has.objects.create(
                        unique_id=student, skill_id=skill_id, skill_rating=skill_rating
                    )
                    has_obj.save()
            ...
            if "patentsubmit" in request.POST:
                ...
                if form.is_valid():
                    ...
                    patent_obj = Patent.objects.create(
                        unique_id=student,
        ...
        if (
            "coursesubmit" in request.POST
            or "educationsubmit" in request.POST
            or "deleteedu" in request.POST
            or "deletecourse" in request.POST
        ):
            return render(request, "globals/student_profile3.html", context)
        if (
            "experiencesubmit" in request.POST
            or "projectsubmit" in request.POST
            or "deleteexp" in request.POST
            or "deletepro" in request.POST
        ):
...
def issue(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            issue.save()
            openissue = (
                Issue.objects.select_related("user")
                .prefetch_related("images", "support")
                .filter(closed=False)
            )
            closedissue = (
                Issue.objects.select_related("user")
