    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="student", max_length=50, unique=True),
                ),
                (
                    "full_name",
                    models.CharField(
                        default="Computer Science and Engineering", max_length=100
                    ),
                ),
                (
                    "type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_status",
                    models.CharField(
                        choices=[("PRESENT", "PRESENT"), ("NEW", "NEW")],
                        default="PRESENT",
                        max_length=50,
                    ),
                ),
                ...
                (
                    "profile_picture",
                    models.ImageField(
                        blank=True, null=True, upload_to="globals/profile_pictures"
                    ),
                ),
                (
                    "about_me",
                    models.TextField(blank=True, default="NA", max_length=1000),
                ),
                (
                    "date_modified",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to=applications.globals.models.Issue_image_directory
                    ),
                ),
                (
                    "user",
